...
<?php include "includes/header.php"; ?>
	<section id="container">
        ...
        ?>
		<h1><i class="fas fa-industry"></i> Lista de Fornecedor</h1>
        <a href="registro_proveedor.php" class="btn_new"><i class="fas fa-plus-circle"></i>Registrar Fornecedorr</a>
        ...
        <?php
        //Paginador 
        $sql_registe = mysqli_query($conn, "SELECT COUNT(*) as total_registro FROM proveedor 
