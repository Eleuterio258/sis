<?php
        ...
        empty($_POST['foto_actual']) || empty($_POST['foto_remove']))
        {
            ...
            if($nombre_foto != '')
            {
                ...
                if($query_update){
                    ...
                    $alert='<p class="msg_save">Produto atualizado com sucesso.</p>';
                }else{
                    $alert='<p class="msg_error">Erro ao atualizar o produto.</p>';
                }
            }    
            }
    ...
    if(empty($_REQUEST['id'])){
        ...
        $query_producto = mysqli_query($conn,"SELECT p.codproducto,p.descripcion,p.precio,p.foto,pr.codproveedor,pr.proveedor
                                                        FROM producto p
...
<?php include "includes/header.php"; ?>
	<section id="container">
        ...
        <h1><i class="fas fa-boxes"></i> Actualizar Produto</h1>
        <hr> 
        ...
        <input type="hidden" id="foto_remove" name="foto_remove" value="<?php echo $data_producto['foto']; ?>">
            ...
            <?php
                $query_proveedor = mysqli_query($conn, "SELECT*FROM proveedor WHERE estatus= 1 ORDER BY proveedor ASC");
            ...
            <input type="text" name="producto" id="producto" placeholder="Nome do produto" value="<?php echo $data_producto['descripcion'] ?>">
            <label for="precio">Preço</label>
            <input type="number" name="precio" id="precio" placeholder="Preço do produto" value="<?php echo $data_producto['precio'] ?>">
                <div class="photo">
            ...
            <input type="submit" value="Actualizar Produto" class="btn_save">
