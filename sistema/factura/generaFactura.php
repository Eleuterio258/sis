<?php
	...
	{
		echo "Não é possível gerar a fatura.";
	}else{
		...
		$query = mysqli_query($conn,"SELECT f.nofactura, DATE_FORMAT(f.fecha, '%d/%m/%Y') as fecha, DATE_FORMAT(f.fecha,'%H:%i:%s') as hora, f.codcliente, f.estatus,
