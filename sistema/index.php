...
//Dados da empresa
	...
	$query_empresa = mysqli_query($conn,"SELECT * FROM configuracion");
				...
				<div class="containerDataUser">
					<div class="divDataUser">
						...
						<form action="" method="post" name="frmChangePass" id="frmChangePass">
							...
							<div>
								<button type="submit" class="btn_save btnChangePass"><i class="fas fa-key"></i> Mudar senha</button>
							</div>
				...
				<div class="logoEmpresa">
					...
					<form action="" method="post" name="frmEmpresa" id="frmEmpresa">
						<input type="hidden" name="action" value="updateDataEmpresa">
							...
							<div>
								<label>Categoria:</label><input type="text" name="txtRSocial" id="txtRSocial"
