...
<?php include "includes/header.php"; ?>
	<section id="container">
		<h1><i class="fas fa-industry"></i> Lista de Fornecedores</h1>
        <a href="registro_fornecedor.php" class="btn_new"><i class="fas fa-plus-circle"></i> Registrar Fornecedor</a>
        
        <form action="buscar_fornecedor.php" method="get" class="form_search">
        ...
        $total_paginas = ceil($total_registro / $por_pagina);
            ...
            if($result > 0){
                ...
                <td>
                    <a class="link_edit" href="editar_fornecedor.php?id=<?php echo $data["codproveedor"]; ?>"><i class="fas fa-edit"></i> Editar</a>
                    |
                    <a class="link_delete" href="eliminar_confirmar_fornecedor.php?id=<?php echo $data["codproveedor"];?>"><i class="fas fa-trash-alt"></i> Eliminar</a>
                </td>
            </tr>
            <?php
                    }
