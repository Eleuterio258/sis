    ...
    if(!empty($_POST))
    {
        ...
        if(empty($_POST['proveedor']) || empty($_POST['producto']) || empty($_POST['precio']) || empty($_POST['cantidad']))
        {
            ...
            if($nombre_foto != '')
            {
                ...
                $query_insert = mysqli_query($conn,"INSERT INTO producto(proveedor,descripcion,precio,existencia,usuario_id,foto)
...
<?php include "includes/header.php"; ?>
	<section id="container">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <input type="number" name="cantidad" id="cantidad" placeholder="Quantidade de produto">
