<?php
    ...
    if(!empty($_POST))
    {
        ...
        || empty($_POST['rol']))
        {
            ...
            $query = mysqli_query($conn,"SELECT * FROM usuario WHERE usuario = '$user' OR correo = '$email' ");
            mysqli_close($conn);
            ...
            if($result > 0){
                ...
                if($query_insert){
                    $alert='<p class="msg_save">Usuario creado correctamemte.</p>';
                }else{
...
<?php include "includes/header.php"; ?>
	<section id="container">
        ...
        <form action="" method="post">
            ...
            <input type="password" name="clave" id="clave" placeholder="senha">
            ...
            <input type="submit" class="btn_save" value="Guardar Usuario">
